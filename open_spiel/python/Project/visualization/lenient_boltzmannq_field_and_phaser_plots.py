...
from open_spiel.python.Project.visualization import dynamics_lb
...
for i, K in zip(range(6),reversed([1,2,5,10,15,25])):
    ...
    ax1.quiver(dyn_stag_hunt) if PLOT_FLAG else ax1.streamplot(dyn_stag_hunt, linewidth="velocity", arrowstyle ="->",maxlength = 0.2, density =0.8)
